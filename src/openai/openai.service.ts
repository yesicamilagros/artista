...
export class OpenaiService {
  ...
  async generateAIResponse(userID: string, userInput: string) {
    try {
      const systemPrompt = `Eres Milagros, un asistente de ventas de una clinica de depilacion laser de nombre Depilzone,debes ser  creativo y amable, que se comunica por WhatsApp.
